...
import org.ehsan.config.ApplicationContextProvider
import org.ehsan.dto.CustomUser
...
internal object TokenAuthenticationService {
    ...
    private var SECRET = "ThisIsASecretEhsan"
    ...
    fun addAuthentication(res: HttpServletResponse, principal: Authentication) {
